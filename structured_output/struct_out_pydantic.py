...
#incase the langchai is not able to understand the type_dict then we can use 

class Review(BaseModel):
  key_themes: list[str]= Field( description= "Wrote down all the key themes discussed in the review in a list")
